...
import { StyledDiv,BottomBorder ,StyledLi, SurveyInput} from '../../../Header/styles'
  ...
  <OverlayTrigger
          ...
          overlay={
            <Popover id='popover-positioned-top' style={{width:"23rem"}}>
              <Popover.Header as="h3"  style={{boxSizing:"borderBox",border:"1px solid lightgrey",outline:"none",borderRadius:"0px",background:"white",overflowY:"none"}}>
<StyledDiv DP="flex" FD="row" AI="center" style={{overflowY:"none"}}>
...
<>
                ...
                <StyledLi style={{marginBottom:".5rem"}} onClick={()=>handleClick(item,ind,Qn)}><b>{item.icons}</b>&nbsp;&nbsp;<i>{item.title}</i></StyledLi>
            

</>
              )
             })}
              <BottomBorder style={{marginTop:"1rem"}} BB="1px solid lightgrey"></BottomBorder>
...
<StyledLi style={{marginBottom:".5rem"}} onClick={()=>handleClick(item,ind,Qn)}><b>{item.icons}</b>&nbsp;&nbsp;<i>{item.title}</i></StyledLi>
            ...
            <BottomBorder style={{marginTop:"1rem",marginBottom:"none"}} BB="1px solid lightgrey"></BottomBorder>
              </StyledDiv>
