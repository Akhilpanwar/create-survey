...
function File() {
  return (
      ...
      <StyledDiv DP="flex" HG="20rem" WD="100%" JC="center" AI="center">
        ...
        >  
        <StyledDiv DP="flex" FD="column" AI="center"  style={{minWidth:"100%" }} JC="center">
        <Heading FS="15px" FW="200">Drop a file here or click the button below to load the file.</Heading>
